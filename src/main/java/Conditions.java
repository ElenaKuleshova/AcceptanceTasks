public class Conditions {
    ...
    /**
     * Task 7-1: Инженер Феродов создал устройство, на табло которого показывается количество секунд,
    ...
    /**
     * Task 7-2: Программист Васильев заметил, как страдают офисные сотрудницы —
    ...
    /**
     * Task 7-3: Итак, в переменную n должно записываться случайное (на время тестирования программы)
